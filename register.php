...
<?php
		...
		if($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			if (mysqli_num_rows($result) > 0) 
			{
				...
				$sql2 = "INSERT INTO `signtable`(`username`, `password`, `companyName`, `mailAddress`, `address`, `moduleNumber`, `publicKey`, `privateKey`) VALUES ('$username','$password','$companyName','$mailAddress','$address',12,34,56)";
